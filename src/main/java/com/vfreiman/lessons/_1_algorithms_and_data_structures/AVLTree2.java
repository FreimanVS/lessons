...
public class AVLTree2 {
    ...
    public int indexOf(int k) {
        ...
        int index = root.left != null ? root.left.size + 1 : 1;
        while (findingNode.value != k) {
            if (k < findingNode.value) {

                findingNode = findingNode.left;
                int rightSize = findingNode.right != null ? findingNode.right.size : 0;
                index = index - rightSize - 1;

            } else {
                findingNode = findingNode.right;

                int leftSize = findingNode.left != null ? findingNode.left.size : 0;
    ...
    public void removeByOrderStat(int index) {
        remove(orderStatistics(index));
    }
    ...
    public void rotateRight(Node node) {
        ...
        if (node.right.right != null && node.right.left != null && node.right.right.h >= node.right.left.h
            ...
            workNode = b;
                ...
                && node.right.left.h > node.right.right.h
                || node.right.right == null && node.right.h > 1) { // a big right rotate
            Node parentA = node.parent;
            Node a = node;
            Node b = node.right;
    ...
    public void rotateLeft(Node node) {
        //a small left rotate
        if (node.left.left != null && node.left.right != null && node.left.left.h >= node.left.right.h
            ...
            workNode = b;
                ...
                || node.left.left == null && node.left.h > 1) { // a big left rotate
            Node parentA = node.parent;
            Node a = node;
            Node b = node.left;
